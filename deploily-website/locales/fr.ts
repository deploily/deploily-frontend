export default {
  ...
  'service.title4': 'Ressources cloud évolutives',
  'service.description4': "Déployez des VPS et des machines virtuelles à la demande en toute simplicité. Évoluez sans effort, optimisez les performances et éliminez les contraintes d’infrastructure. Que vous lanciez un projet, effectuiez des tests ou développiez votre activité, nos ressources cloud flexibles s’adaptent à vos besoins—rapides, fiables et sans tracas.",
