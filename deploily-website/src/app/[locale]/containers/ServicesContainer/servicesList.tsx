...
function isOdd(num:any) { return num % 2; }
      ...
      {allServices(scopedService).map((service, index) => (
        <div key={index}>
          <Row
            ...
            style={{ flexDirection: isOdd(index) === 0 ? 'row' : 'row-reverse' , backgroundColor: token.colorBgBase,}}
          ...
          >
            ...
            <Col
              ...
              style={{
                display: 'flex',
                flexDirection: isOdd(index) === 0 ? 'row' : 'row-reverse',
            ...
            >
              ...
              >
                <Title level={3} style={{ fontWeight: 'bold', fontSize: '25px' ,color:token.colorTextBase,}}>
